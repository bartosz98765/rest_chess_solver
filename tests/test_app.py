...
def test_moves_king(client):
    ...
    assert response.get_json() == {'availableMoves': ['A2', 'B1', 'B2'],
                                   'currentField': 'A1',
                                   'error': None,
                                   'figure': 'king'}
    # invalid field
...
def test_validation_queen(client):
    ...
    assert response.status_code == 200
    assert response.get_json() == {"currentField": "D1",
                                   "destField": "D2",
                                   "error": None,
                                   "figure": "queen",
                                   "move": "valid"}
...
def test_validation_rook(client):
    ...
    assert response.status_code == 200
    assert response.get_json() == {"currentField": "A1",
                                   "destField": "A8",
                                   "error": None,
                                   "figure": "rook",
                                   "move": "valid"}
...
def test_moves_bishop(client):
    ...
    assert response.status_code == 200
    assert response.get_json() == {'availableMoves': ["A8", "B7", "C6", "D5", "E4", "F3", "G2"],
                                   'currentField': 'H1',
                                   'error': None,
                                   'figure': 'bishop'}
    # invalid field
...
def test_validation_bishop(client):
    ...
    assert response.status_code == 200
    assert response.get_json() == {"currentField": "H1",
                                   "destField": "A8",
                                   "error": None,
                                   "figure": "bishop",
                                   "move": "valid"}
...
def test_moves_knight(client):
    ...
    assert response.status_code == 200
    assert response.get_json() == {'availableMoves': ["B6", "C7"],
                                   'currentField': 'A8',
                                   'error': None,
                                   'figure': 'knight'}
    # invalid field
...
def test_moves_pawn(client):
    ...
    assert response.status_code == 200
    assert response.get_json() == {'availableMoves': ["A3", "A4"],
                                   'currentField': 'A2',
                                   'error': None,
                                   'figure': 'pawn'}
    ...
    assert response.status_code == 200
    assert response.get_json() == {'availableMoves': ["B4"],
                                   'currentField': 'B3',
                                   'error': None,
                                   'figure': 'pawn'}
...
def test_validation_pawn(client):
    ...
    assert response.status_code == 200
    assert response.get_json() == {"currentField": "D2",
                                   "destField": "D4",
                                   "error": None,
                                   "figure": "pawn",
                                   "move": "valid"}
    ...
    assert response.status_code == 200
    assert response.get_json() == {"currentField": "D3",
                                   "destField": "D4",
                                   "error": None,
                                   "figure": "pawn",
                                   "move": "valid"}
